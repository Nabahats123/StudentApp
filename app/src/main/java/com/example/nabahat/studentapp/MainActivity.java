...
*/
                ...
                .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton button,
                        ...
                        if (isChecked) {
                            ...
                            StudentPassword.setTransformationMethod(HideReturnsTransformationMethod
                            ...
                            StudentPassword.setTransformationMethod(PasswordTransformationMethod
        ...
        SignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String getEmailId = StudentEmail.getText().toString();
                String getPassword = StudentPassword.getText().toString();
...
//                    loginLayout.startAnimation(shakeAnimation);
        ...
        SignUp.setOnClickListener(this);
               /* final String DName = DriverName.getText().toString();
                final String DEmail = StudentEmail.getText().toString();
