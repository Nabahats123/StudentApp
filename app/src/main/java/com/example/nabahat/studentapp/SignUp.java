...
public class SignUp extends AppCompatActivity {
    ...
    private EditText StudentName, StudentEmail, StudentHome, StudentPassword,  confirmPassword, rollnum;
    private Spinner StudentBusNumber, year, course;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StudentEmail = (EditText) findViewById(R.id.lay_emailSignup);
        StudentHome = (EditText) findViewById(R.id.lay_phone);
        StudentPassword = (EditText) findViewById(R.id.lay_passwordsignup);
        confirmPassword = (EditText) findViewById(R.id.confirmPassword);
        StudentBusNumber = (Spinner) findViewById(R.id.lay_routenumber);
        SignUp = (Button) findViewById(R.id.signUpBtn);
        Already_User = (TextView) findViewById(R.id.already_user);
        forgotPassword = (TextView) findViewById(R.id.forgot_password);
        show_hide_password = (CheckBox) findViewById(R.id.show_hide_password);
        terms_conditions = (CheckBox)findViewById(R.id.terms_conditions);
        StudentBusNumber.setPrompt("Route Number");
        ...
        firebaseauthlistener = new FirebaseAuth.AuthStateListener(){
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user!= null){
                    Intent OpenMap = new Intent(SignUp.this, StudentHome.class);
...
*/
        ...
        SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String getFullName = StudentName.getText().toString();
                final String getEmailId = StudentEmail.getText().toString();
                final String getMobileNumber = StudentHome.getText().toString();
                final String getLocation = StudentBusNumber.getSelectedItem().toString();
                final String getPassword = StudentPassword.getText().toString();
                String getConfirmPassword = confirmPassword.getText().toString();
                final String getRegno = rollnum.getText().toString();
                final String getyear = year.getSelectedItem().toString();
                final String getprogram = course.getSelectedItem().toString();
                    ...
                    mAuth.createUserWithEmailAndPassword(getEmailId, getPassword).addOnCompleteListener(SignUp.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                final Student student = new Student(user_Id, getyear, getprogram, getRegno, getFullName, getEmailId, getPassword, getMobileNumber, getLocation);
